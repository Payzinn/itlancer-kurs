...
<?php
$select_specialists = "SELECT `portfolio`.*, `sphere_types`.`name` AS `sphere_types_name`, `spheres`.`name` AS `spheres_name`, `users`.`login` AS `user_login`, `users`.`date` AS `user_date`
FROM `portfolio` 
